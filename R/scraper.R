...
#' Scrape a tableau dashboard.
#'
#' @param config A list with fields `host_url`, `path`, and `req_url`.
#' Can be generated by `gen_config()`.
#'
#' @return A list of dataframes behind the dashboard.
#' @examples
#' \dontrun{
#' config <- gen_config(
